# -*- coding: utf-8 -*-
"""
Created on Tue Jul 17 23:32:28 2018

@author: kingkong
"""
import tensorflow.contrib.model_pruning.examples.cifar10.cifar10 as cifar10 
import tensorflow.contrib.model_pruning.examples.cifar10.cifar10_input as cifar10_input
...
images_test, labels_test = cifar10_input.read_cifar10(eval_data=True,
                                                data_dir=data_dir,
                                                batch_size=batch_size)
